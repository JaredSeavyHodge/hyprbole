...
verify_installation() {
  ...
  for binary in hyprland uwsm waybar ghostty nautilus swaync swayosd-client yay snapper sddm limine-update mkdocs code nvim rg fd unzip lazygit tree-sitter; do
