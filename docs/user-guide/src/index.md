...
Use this guide when you want to learn the desktop, recover from a bad edit, change everyday defaults, or understand what Hyprbole installed.

## Start Here

- Just installed? Start with [First Boot](first-boot.md).
- New to the desktop? Read [Quick Start](quick-start.md).
- Need every shortcut? Open [Keybinds](keybinds.md).
- Something looks broken, incomplete, or misconfigured? Open [Troubleshooting](troubleshooting.md).
...
The top-left bar shows workspaces. The center and right side show time, status, audio, Bluetooth, notifications, battery, updates, and health alerts.
...
- Read [First Boot](first-boot.md) for the first-login checklist.
